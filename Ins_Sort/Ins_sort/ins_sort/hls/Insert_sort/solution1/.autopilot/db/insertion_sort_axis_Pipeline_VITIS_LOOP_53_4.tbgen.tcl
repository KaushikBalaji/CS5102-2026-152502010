set moduleName insertion_sort_axis_Pipeline_VITIS_LOOP_53_4
set isTopModule 0
...
set C_modelName {insertion_sort_axis_Pipeline_VITIS_LOOP_53_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ indvars_iv1_reload int 7 regular  }
	{ arr int 32 regular {array 25 { 1 3 } 1 1 }  }
	{ arr_1 int 32 regular {array 25 { 1 3 } 1 1 }  }
	{ arr_2 int 32 regular {array 25 { 1 3 } 1 1 }  }
	{ arr_3 int 32 regular {array 25 { 1 3 } 1 1 }  }
	{ n_reload int 7 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv1_reload", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "arr", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "arr_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "arr_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "arr_3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "n_reload", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ indvars_iv1_reload sc_in sc_lv 7 signal 0 } 
	...
	{ n_reload sc_in sc_lv 7 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "indvars_iv1_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "indvars_iv1_reload", "role": "default" }} , 
 	...
 	{ "name": "n_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "n_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "insertion_sort_axis_Pipeline_VITIS_LOOP_53_4",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "3", "EstimateLatencyMax" : "102",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "indvars_iv1_reload", "Type" : "None", "Direction" : "I"},
			{"Name" : "arr", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "arr_1", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "arr_2", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "arr_3", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "n_reload", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_4_2_32_1_1_U20", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	insertion_sort_axis_Pipeline_VITIS_LOOP_53_4 {
		indvars_iv1_reload {Type I LastRead 0 FirstWrite -1}
		...
		n_reload {Type I LastRead 0 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "102"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "102"}
]}
...
set Spec2ImplPortList { 
	indvars_iv1_reload { ap_none {  { indvars_iv1_reload in_data 0 7 } } }
	arr { ap_memory {  { arr_address0 mem_address 1 5 }  { arr_ce0 mem_ce 1 1 }  { arr_q0 in_data 0 32 } } }
	arr_1 { ap_memory {  { arr_1_address0 mem_address 1 5 }  { arr_1_ce0 mem_ce 1 1 }  { arr_1_q0 in_data 0 32 } } }
	arr_2 { ap_memory {  { arr_2_address0 mem_address 1 5 }  { arr_2_ce0 mem_ce 1 1 }  { arr_2_q0 in_data 0 32 } } }
	arr_3 { ap_memory {  { arr_3_address0 mem_address 1 5 }  { arr_3_ce0 mem_ce 1 1 }  { arr_3_q0 in_data 0 32 } } }
	n_reload { ap_none {  { n_reload in_data 0 7 } } }
