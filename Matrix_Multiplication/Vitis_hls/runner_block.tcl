...
set design_file "matmul_block_1.cpp"
...
file copy -force "$project_name/$solution_name/syn/report/MATMUL_csynth.rpt" "reports/csynth_block_report1.rpt"

file copy -force "$project_name/$solution_name/syn/report/csynth_design_size.rpt" "reports/design_block_size1.rpt"
...
file copy -force "vitis_hls.log" "reports/vitis_hls_block1.log"
