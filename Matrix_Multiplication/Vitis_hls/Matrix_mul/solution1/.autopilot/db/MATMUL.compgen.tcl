...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler MATMUL_A_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
# RegSlice definition:
set ID 1160
set RegSliceName MATMUL_regslice_both
set RegSliceInstName MATMUL_regslice_both_U
set CoreName ap_simcore_MATMUL_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
