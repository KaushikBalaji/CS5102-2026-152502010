; ModuleID = '/home/sem2/SoC_Lab/Matrix_Mul/vitis_hls/Matrix_mul/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_MATMUL_ir(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias nocapture nonnull dereferenceable(128) %s_axis, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias nocapture nonnull dereferenceable(128) %m_axis) local_unnamed_addr #0 {
entry:
  %s_axis_copy.data = alloca i512
  %s_axis_copy.keep = alloca i64
  %s_axis_copy.strb = alloca i64
  %s_axis_copy.last = alloca i1
  %m_axis_copy.data = alloca i512
  %m_axis_copy.keep = alloca i64
  %m_axis_copy.strb = alloca i64
  %m_axis_copy.last = alloca i1
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* nonnull %s_axis, i512* %s_axis_copy.data, i64* %s_axis_copy.keep, i64* %s_axis_copy.strb, i1* %s_axis_copy.last, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* nonnull %m_axis, i512* %m_axis_copy.data, i64* %m_axis_copy.keep, i64* %m_axis_copy.strb, i1* %m_axis_copy.last)
  call void @apatb_MATMUL_hw(i512* %s_axis_copy.data, i64* %s_axis_copy.keep, i64* %s_axis_copy.strb, i1* %s_axis_copy.last, i512* %m_axis_copy.data, i64* %m_axis_copy.keep, i64* %m_axis_copy.strb, i1* %m_axis_copy.last)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %s_axis, i512* %s_axis_copy.data, i64* %s_axis_copy.keep, i64* %s_axis_copy.strb, i1* %s_axis_copy.last, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %m_axis, i512* %m_axis_copy.data, i64* %m_axis_copy.keep, i64* %m_axis_copy.strb, i1* %m_axis_copy.last)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias, i512* noalias "unpacked"="1.0" %_V_data_V, i64* noalias "unpacked"="1.1" %_V_keep_V, i64* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias, i512* noalias "unpacked"="3.0" %_V_data_V1, i64* noalias "unpacked"="3.1" %_V_keep_V2, i64* noalias "unpacked"="3.2" %_V_strb_V3, i1* noalias "unpacked"="3.3" %_V_last_V4) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.12"(i512* %_V_data_V, i64* %_V_keep_V, i64* %_V_strb_V, i1* %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.12"(i512* %_V_data_V1, i64* %_V_keep_V2, i64* %_V_strb_V3, i1* %_V_last_V4, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %1)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias, i512* noalias "unpacked"="1.0" %_V_data_V, i64* noalias "unpacked"="1.1" %_V_keep_V, i64* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias, i512* noalias "unpacked"="3.0" %_V_data_V1, i64* noalias "unpacked"="3.1" %_V_keep_V2, i64* noalias "unpacked"="3.2" %_V_strb_V3, i1* noalias "unpacked"="3.3" %_V_last_V4) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.7"(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* nonnull align 512 %dst, i512* %src_V_data_V, i64* %src_V_keep_V, i64* %src_V_strb_V, i1* %src_V_last_V)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.7"(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias nocapture align 512, i512* noalias nocapture "unpacked"="1.0" %_V_data_V, i64* noalias nocapture "unpacked"="1.1" %_V_keep_V, i64* noalias nocapture "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture "unpacked"="1.3" %_V_last_V) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.12"(i512* noalias "unpacked"="0.0" %dst_V_data_V, i64* noalias "unpacked"="0.1" %dst_V_keep_V, i64* noalias "unpacked"="0.2" %dst_V_strb_V, i1* noalias "unpacked"="0.3" %dst_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias %src) unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.15"(i512* %dst_V_data_V, i64* %dst_V_keep_V, i64* %dst_V_strb_V, i1* %dst_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.15"(i512* noalias nocapture "unpacked"="0.0" %_V_data_V, i64* noalias nocapture "unpacked"="0.1" %_V_keep_V, i64* noalias nocapture "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "unpacked"="0.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias nocapture) unnamed_addr #4 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"
...
declare void @apatb_MATMUL_hw(i512*, i64*, i64*, i1*, i512*, i64*, i64*, i1*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias, i512* noalias "unpacked"="1.0" %_V_data_V, i64* noalias "unpacked"="1.1" %_V_keep_V, i64* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias, i512* noalias "unpacked"="3.0" %_V_data_V1, i64* noalias "unpacked"="3.1" %_V_keep_V2, i64* noalias "unpacked"="3.2" %_V_strb_V3, i1* noalias "unpacked"="3.3" %_V_last_V4) unnamed_addr #2 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %0, i512* %_V_data_V, i64* %_V_keep_V, i64* %_V_strb_V, i1* %_V_last_V)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %1, i512* %_V_data_V1, i64* %_V_keep_V2, i64* %_V_strb_V3, i1* %_V_last_V4)
  ret void
...
define void @MATMUL_hw_stub_wrapper(i512*, i64*, i64*, i1*, i512*, i64*, i64*, i1*) #5 {
entry:
  %8 = alloca %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"
  %9 = alloca %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %8, i512* %0, i64* %1, i64* %2, i1* %3, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %9, i512* %4, i64* %5, i64* %6, i1* %7)
  call void @MATMUL_hw_stub(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %8, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %9)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %8, i512* %0, i64* %1, i64* %2, i1* %3, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %9, i512* %4, i64* %5, i64* %6, i1* %7)
  ret void
}

declare void @MATMUL_hw_stub(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"*, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"*)
