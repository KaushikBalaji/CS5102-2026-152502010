...
# 3 "Matrix_mul/mat_mul.cpp" 2
# 1 "/home/Vivado/Vitis_HLS/2023.1/common/technology/autopilot/ap_int.h" 1
# 4 "Matrix_mul/mat_mul.cpp" 2
...
__attribute__((sdx_kernel("MATMUL", 0))) void MATMUL(hls::stream<axis_512_t> &s_axis,
            hls::stream<axis_512_t> &m_axis) {
#line 16 "/home/sem2/SoC_Lab/Matrix_Mul/vitis_hls/Matrix_mul/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=MATMUL
# 12 "Matrix_mul/mat_mul.cpp"
...
#pragma HLS PIPELINE II=1
 axis_512_t pkt = s_axis.read();
        VITIS_LOOP_29_1: for(int k = 0; k < 16; k++) {
#pragma HLS UNROLL
...
#pragma HLS PIPELINE II=1
 axis_512_t pkt = s_axis.read();
        VITIS_LOOP_39_2: for(int k = 0; k < 16; k++) {
#pragma HLS UNROLL
...
#pragma HLS PIPELINE II=1
 ap_uint<512> result = 0;
        VITIS_LOOP_62_3: for(int j = 0; j < 16; j++) {
#pragma HLS UNROLL
