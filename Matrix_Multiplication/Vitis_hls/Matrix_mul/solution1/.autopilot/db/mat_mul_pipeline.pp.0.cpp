# 1 "Matrix_mul/mat_mul_pipeline.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Matrix_mul/mat_mul_pipeline.cpp" 2
...
# 2 "Matrix_mul/mat_mul_pipeline.cpp" 2
...
# 3 "Matrix_mul/mat_mul_pipeline.cpp" 2
# 1 "/home/Vivado/Vitis_HLS/2023.1/common/technology/autopilot/ap_int.h" 1
# 4 "Matrix_mul/mat_mul_pipeline.cpp" 2
...
void MATMUL_PIPE_STREAM(hls::stream<axis_512_t> &s_axis,
...
#pragma HLS PIPELINE II=1
 axis_512_t pkt = s_axis.read();
        ...
        VITIS_LOOP_31_1: for(int k=0;k<16;k++){
#pragma HLS UNROLL
...
#pragma HLS PIPELINE II=1
 axis_512_t pkt = s_axis.read();
        ...
        VITIS_LOOP_43_2: for(int k=0;k<16;k++){
#pragma HLS UNROLL
...
#pragma HLS PIPELINE II=1
 ...
 ap_uint<512> result = 0;
        ...
        VITIS_LOOP_75_3: for(int j=0;j<16;j++){
#pragma HLS UNROLL
